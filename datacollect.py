...
def processsat(file, crops,cd_gt, band1, band2, band3, band4, crop, cd_cs, cd_data):
    sd = gdal.Open(file)
...
def collect():
    ...
    for file in satfiles:
        processsat(file,crop = crop, band1= band1, band2 = band2, band3 = band3, band4 = band4, crops = crops, cd_gt = cd_gt, cd_data = cd_data, cd_cs = cd_cs)
